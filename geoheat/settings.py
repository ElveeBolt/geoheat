"""
Django settings for geoheat project.
...
SECRET_KEY = 'django-insecure-jl^&wc2ax@hgx_4q@d^a8d0m00c)oh9w0-ti#ty%=itntnwmbu'
...
WSGI_APPLICATION = 'geoheat.wsgi.application'
